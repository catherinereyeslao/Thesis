...
public class ChapterSelect extends AppView {
    ...
    public void setUp(int screenW, int screenH) {
       ...
       /* chap1Texture = new Texture("buttons/chapters/b1-1.png");
        ...
        chap5Texture = new Texture("buttons/chapter2/a5btn.png");
        chap6Texture = new Texture("buttons/chapter2/a6btn.png");
        chap7Texture = new Texture("buttons/chapter2/a7btn.png");
        chap8Texture = new Texture("buttons/chapter2/a8btn.png");
        chap9Texture = new Texture("buttons/chapter2/a9btn.png");
        chap10Texture = new Texture("buttons/chapter2/a10btn.png");
        chap11Texture = new Texture("buttons/chapter2/a11btn.png");
        chap12Texture = new Texture("buttons/chapter2/a12btn.png");
        chap13Texture = new Texture("buttons/chapter2/a13btn.png");
        chap14Texture = new Texture("buttons/chapter2/a14btn.png");
        chap15Texture = new Texture("buttons/chapter2/a15btn.png");
